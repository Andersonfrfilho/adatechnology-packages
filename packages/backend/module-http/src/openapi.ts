...
import { ROUTE_SCOPE, type ModuleRoute, type ModuleRouteTable } from './types'
...
export function moduleOpenApiPaths(params: {
  routes: ModuleRouteTable
  basePath?: string
  /** Agrupa as rotas no Swagger do host — `['catalog']`, `['notifications']`. */
