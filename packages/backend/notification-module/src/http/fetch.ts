...
export type NotificationFetchRouter = {
...
export type CreateNotificationFetchRouterParams = {
  readonly routes: NotificationRouteTable
...
function toStreamResponse(result: Extract<NotificationHttpResult, { kind: 'stream' }>, signal: AbortSignal): Response {
...
export function toFetchResponse(result: NotificationHttpResult, signal: AbortSignal): Response {
...
export function createNotificationFetchRouter(params: CreateNotificationFetchRouterParams): NotificationFetchRouter {
