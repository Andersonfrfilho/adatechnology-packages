...
export function normalizeDecimal({ errorCodePrefix, maximumScale, value }: NormalizeDecimalParams): string {
...
export function parseScaledDecimal({ errorCodePrefix, scale, value }: ParseScaledDecimalParams): bigint {
