...
import { resolveCargoPlacement, type CargoPlacement, type PlacementBox } from '../../src/cargo-placement.policy.js'
import { ATEGO_85_STOPS } from '../../src/fixtures/real-mixed-cargo.fixture.js'
...
describe('a busca de lugar vai até a porta (spec 116, contrato da spec 117)', () => {
  ...
  test('num baú de 7,40 m com 85 paradas, o que fica fora cabe na escada da porta', () => {
    ...
    expect(unplacedOf(plan)).toBeLessThanOrEqual(DOOR_STAIRCASE_BOXES + UNREACHABLE_TOP_BOXES + LEDGE_BRACE_COST_BOXES)
  })
})
