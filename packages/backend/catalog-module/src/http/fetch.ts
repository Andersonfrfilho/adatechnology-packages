 ...
 * para o host importar `@adatechnology/catalog-module/http/fetch` sem saber que o encanamento é
 * compartilhado — e para a troca do pacote base não virar breaking change no consumidor.
 */
