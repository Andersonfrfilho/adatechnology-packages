...
import { QUEUE_CONFIG, PROCESSING_STAGES, STAGE_LABELS, STAGE_PROGRESS, STAGE_DURATION_SECONDS } from '../constants/index.js';
...
export async function setupDubbingWorker(
  ...
  const worker = new Worker<JobData>(
    ...
    async (job: Job<JobData>) => {
      const { jobId, videoUrl, outputType, targetLanguages } = job.data;
      ...
      try {
        ...
        let translatedSegments = transcriptData.transcript;
