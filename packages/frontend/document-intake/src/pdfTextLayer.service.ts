...
export type PdfGetDocument = (parameters: { data: Uint8Array; isEvalSupported: boolean }) => PdfLoadingTask
 ...
 */
export async function readPdfTextLayer(input: { data: Uint8Array; getDocument: PdfGetDocument }): Promise<PdfPageText> {
