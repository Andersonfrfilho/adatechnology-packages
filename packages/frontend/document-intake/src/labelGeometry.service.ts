...
export function findLabelFragment(fragments: readonly PdfTextFragment[], label: string): PdfTextFragment | undefined {
 ...
 */
export function readValueBelowLabel(fragments: readonly PdfTextFragment[], label: string): string | undefined {
